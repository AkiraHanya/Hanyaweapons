...
import java.util.function.Supplier;
    ...
    public enum ModArmorMaterials implements ArmorMaterial {
        PIGLINCROWN("piglincrown", 0, new int[]{ 5, 7, 5, 4 }, 25,
                SoundEvents.ARMOR_EQUIP_GOLD, 1f, 0f, () -> Ingredient.of(Moditems.DIMENSIONALKATANA.get()));
        ...
        public String getName() {
            return HanyaWeapons.MOD_ID + ":" + this.name;
        }
